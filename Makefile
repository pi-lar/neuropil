...
SOURCES  = src/dtime.c src/np_jtree.c src/jval.c 
SOURCES += src/np_key.c src/np_message.c src/np_memory.c src/np_glia.c src/neuropil.c src/np_jobqueue.c 
SOURCES += src/np_aaatoken.c src/log.c src/np_network.c src/np_node.c src/np_axon.c src/np_container.c 
SOURCES += src/np_dendrit.c src/np_util.c src/np_route.c src/np_msgproperty.c src/np_keycache.c
