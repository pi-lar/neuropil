...
sll_return(np_msgproperty_ptr) default_msgproperties() {
	...
	__default_properties->clb_inbound = _np_in_received;
	...
	__handshake_properties->clb_outbound = _np_send_handshake;
	__handshake_properties->clb_inbound = _np_in_handshake;
	__handshake_properties->clb_transform = _np_send_handshake;
	__handshake_properties->clb_route = _np_never_called_jobexec_route;
	...
	__join_ack->retry = 5;
	__join_ack->clb_inbound = _np_in_join_ack;
	__join_ack->clb_outbound = _np_send;
	__join_ack->clb_transform = _np_never_called_jobexec_transform;
	__join_ack->clb_route = _np_never_called_jobexec_route;
	...
	__join_nack->retry = 5;
	__join_nack->clb_inbound = _np_in_join_nack;
	__join_nack->clb_outbound = _np_send;
	__join_nack->clb_transform = _np_never_called_jobexec_transform;
	__join_nack->clb_route = _np_never_called_jobexec_route;
	...
	__leave_properties->ack_mode = ACK_EACHHOP;
	__leave_properties->retry = 5;
	__leave_properties->clb_inbound = _np_in_leave_req;
	__leave_properties->clb_outbound = _np_send;
	__leave_properties->clb_transform = _np_never_called_jobexec_transform;
	__leave_properties->clb_route = _np_route_lookup_jobexec;
	...
	__piggy->retry = 0;
	__piggy->clb_inbound = _np_in_piggy;
	__piggy->clb_outbound = _np_send;
	__piggy->clb_transform = _np_send_rowinfo_jobexec;
	__piggy->clb_route = _np_route_lookup_jobexec;
	...
	__update->priority = 0;
	__update->ack_mode = ACK_EACHHOP;
	__update->retry = 5;
	__update->clb_inbound = _np_in_update;
	__update->clb_outbound = _np_send;
	__update->clb_transform = _np_never_called_jobexec_transform;
	__update->clb_route = _np_route_lookup_jobexec;
	...
	__discover_receiver->clb_route = _np_route_lookup_jobexec;
	...
	__discover_sender->clb_route = _np_route_lookup_jobexec;
	...
	__available_receiver->clb_route = _np_route_lookup_jobexec;
	...
	__available_sender->clb_route = _np_route_lookup_jobexec;
	...
	__authenticate->ack_mode = ACK_EACHHOP;
	__authenticate->retry = 5;
	__authenticate->clb_inbound = _np_in_authenticate;
	__authenticate->clb_outbound = _np_send;
	__authenticate->clb_route = _np_route_lookup_jobexec;
	__authenticate->clb_transform = _np_send_authentication_request;
	...
	__authenticate_reply->ack_mode = ACK_EACHHOP;
	__authenticate_reply->retry = 5;
	__authenticate_reply->clb_inbound = _np_in_authenticate_reply;
	__authenticate_reply->clb_outbound = _np_send;
	__authenticate_reply->clb_transform = _np_send_authentication_reply;
	__authenticate_reply->clb_route = _np_route_lookup_jobexec;
	...
	__authorize->ack_mode = ACK_EACHHOP;
	__authorize->retry = 5;
	__authorize->clb_inbound = _np_in_authorize;
	__authorize->clb_outbound = _np_send;
	__authorize->clb_route = _np_route_lookup_jobexec;
	__authorize->clb_transform = _np_send_authorization_request;
	...
	__authorize_reply->ack_mode = ACK_EACHHOP;
	__authorize_reply->retry = 5;
	__authorize_reply->clb_inbound = _np_in_authorize_reply;
	__authorize_reply->clb_outbound = _np_send;
	__authorize_reply->clb_transform = _np_send_authorization_reply;
	__authorize_reply->clb_route = _np_route_lookup_jobexec;
	...
	__account->ack_mode = ACK_EACHHOP;
	__account->retry = 5;
	__account->clb_inbound = _np_in_account;
	__account->clb_outbound = _np_send;
	__account->clb_route = _np_route_lookup_jobexec;
	__account->clb_transform = _np_send_accounting_request;
