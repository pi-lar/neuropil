...
static np_bool read_byte(cmp_ctx_t *ctx, uint8_t *x) {
  return ctx->read(ctx, x, sizeof(uint8_t));
}

static np_bool  write_byte(cmp_ctx_t *ctx, uint8_t x) {
  return (ctx->write(ctx, &x, sizeof(uint8_t)) == (sizeof(uint8_t)));
}

static np_bool read_type_marker(cmp_ctx_t *ctx, uint8_t *marker) {
...
static np_bool write_type_marker(cmp_ctx_t *ctx, uint8_t marker) {
...
static np_bool write_fixed_value(cmp_ctx_t *ctx, uint8_t value) {
...
np_bool cmp_write_bool(cmp_ctx_t *ctx, np_bool b) {
  if (b)
...
np_bool cmp_write_u8_as_bool(cmp_ctx_t *ctx, uint8_t b) {
  if (b)
    return cmp_write_true(ctx);
...
np_bool cmp_write_ext8(cmp_ctx_t *ctx, int8_t tp, uint8_t sz, const void *data) {
...
np_bool cmp_write_ext16(cmp_ctx_t *ctx, int8_t tp, uint16_t sz, const void *data) {
...
np_bool cmp_write_ext32(cmp_ctx_t *ctx, int8_t tp, uint32_t sz, const void *data) {
...
np_bool cmp_write_ext_marker(cmp_ctx_t *ctx, int8_t tp, uint32_t sz) {
  if (sz == 1)
...
np_bool cmp_write_ext(cmp_ctx_t *ctx, int8_t tp, uint32_t sz, const void *data) {
  if (sz == 1)
...
np_bool cmp_read_uinteger(cmp_ctx_t *ctx, uint64_t *d) {
...
np_bool cmp_read_bool(cmp_ctx_t *ctx, np_bool *b) {
  cmp_object_t obj;
...
np_bool cmp_object_is_bool(cmp_object_t *obj) {
  if (obj->type == CMP_TYPE_BOOLEAN)
    return true;
...
np_bool cmp_object_as_uinteger(cmp_object_t *obj, uint64_t *d) {
...
np_bool cmp_object_as_bool(cmp_object_t *obj, np_bool *b) {
  if (obj->type == CMP_TYPE_BOOLEAN) {
    if (obj->as.boolean)
      *b = true;
    else
