...
{
    log_msg(LOG_TRACE, "start: np_bool __np_threads_create_module_mutex(np_module_lock_type module_id){");
...
{
    log_msg(LOG_TRACE, "start: np_bool _np_threads_init(){");
	np_bool ret = TRUE;
...
int _np_threads_lock_module(np_module_lock_type module_id) {
    log_msg(LOG_TRACE, "start: int _np_threads_lock_module(np_module_lock_type module_id) {");
...
int _np_threads_unlock_module(np_module_lock_type module_id) {
    log_msg(LOG_TRACE, "start: int _np_threads_unlock_module(np_module_lock_type module_id) {");
...
{
    log_msg(LOG_TRACE, "start: int _np_threads_mutex_init(np_mutex_t* mutex){");
...
{
    log_msg(LOG_TRACE, "start: int _np_threads_mutex_lock(np_mutex_t* mutex){");
	return pthread_mutex_lock(&mutex->lock);
}
int _np_threads_mutex_unlock(np_mutex_t* mutex)
{
    log_msg(LOG_TRACE, "start: int _np_threads_mutex_unlock(np_mutex_t* mutex){");
	return pthread_mutex_unlock(&mutex->lock);
}
void _np_threads_mutex_destroy(np_mutex_t* mutex)
{
    log_msg(LOG_TRACE, "start: void _np_threads_mutex_destroy(np_mutex_t* mutex){");
...
{
    log_msg(LOG_TRACE, "start: void _np_threads_condition_init(np_cond_t* condition){");
...
{
    log_msg(LOG_TRACE, "start: void _np_threads_condition_destroy(np_cond_t* condition){");
...
{
    log_msg(LOG_TRACE, "start: int _np_threads_condition_wait(np_cond_t* condition, np_mutex_t* mutex){");
	return pthread_cond_wait(&condition->cond, &mutex->lock);
}
int _np_threads_condition_signal(np_cond_t* condition)
{
    log_msg(LOG_TRACE, "start: int _np_threads_condition_signal(np_cond_t* condition){");
