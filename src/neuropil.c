...
enum np_return np_sign_identity(np_context* ac, struct np_token* identity)
{
    np_ctx_cast(ac); 
    ...
    if(identity == NULL) {
        ...
        np_ident_private_token_t* id_token = np_token_factory_new_identity_token(context, 20.0, NULL);
