...
//	char* node_port             = np_tree_find_str(hs_payload, "_np.port")->val.value.s;
//  np_tree_elem_t* public_key  = np_tree_find_str(hs_payload, "_np.public_key");
	np_tree_elem_t* session_key = np_tree_find_str(hs_payload, "_np.session");
