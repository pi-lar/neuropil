...
extern "C" {
   ...
   enum np_log_e
   {
      ...
      LOG_SERIALIZATION	= 0x000000100U, /* debugging the serialization methods		*/
      ...
      LOG_MESSAGE    	= 0x000002000U, /* debugging the message subsystem			*/
      LOG_SECURE     	= 0x000004000U, /* debugging the security module			    */
      LOG_HTTP       	= 0x000008000U, /* debugging the http subsystem			    */
      LOG_AAATOKEN   	= 0x000010000U, /* debugging the aaatoken subsystem		    */
