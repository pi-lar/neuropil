...
#define NP_PLL_GENERATE_PROTOTYPES(TYPE)\
    ...
    void TYPE##_pll_insert(TYPE##_pll_t* pll_list, TYPE value, np_bool dups_ok, TYPE##_cmp_func_t cmp_func);\
...
#define sll_next(sll_elem) (sll_elem = sll_elem == NULL ? NULL : sll_elem->flink)
