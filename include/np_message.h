...
NP_API_INTERN
void _np_message_add_instruction(np_message_t *,
                                 const char  *key,
                                 np_treeval_t value);
NP_API_INTERN
...
NP_API_INTERN
void _np_message_add_property(np_message_t *,
                              const char  *key,
                              np_treeval_t value);
NP_API_INTERN
...
NP_API_INTERN
void _np_message_add_bodyentry(np_message_t *,
                               const char  *key,
                               np_treeval_t value);
NP_API_INTERN
...
NP_API_INTERN
void _np_message_add_footerentry(np_message_t *,
                                 const char  *key,
                                 np_treeval_t value);
NP_API_INTERN
