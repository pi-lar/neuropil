...
NP_API_INTERN
bool _np_out_authentication_request(np_state_t     *context,
                                    np_util_event_t msg_event);
NP_API_INTERN
bool _np_out_authentication_reply(np_state_t     *context,
                                  np_util_event_t msg_event);

// send an authorization request to the target
NP_API_INTERN
bool _np_out_authorization_request(np_state_t     *context,
                                   np_util_event_t msg_event);
NP_API_INTERN
bool _np_out_authorization_reply(np_state_t     *context,
                                 np_util_event_t msg_event);
