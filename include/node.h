...
np_node_t* np_node_decode_from_amqp (np_nodecache_t* gn, pn_data_t* amqp_data);
np_node_t** np_decode_nodes_from_amqp (np_nodecache_t* gn, pn_data_t* amqp_data);
...
void np_node_encode_to_amqp (pn_data_t* amqp_data, np_node_t* np_node);
