...
Test(np_aaatoken_t, create_node_token, .description = "test the creation of a node token")
{
	CTX() {
		...
		cr_expect(true == _np_aaatoken_is_valid(context, test_token_1, np_aaatoken_type_node), "expect that the token is valid");
		...
		cr_assert(true == _np_aaatoken_is_valid(context, test_token_1, np_aaatoken_type_node), "expect that the 1.token (%s) is valid", test_token_1->uuid);
		cr_assert(true == _np_aaatoken_is_valid(context, test_token_2, np_aaatoken_type_node), "expect that the 2.token (%s) is valid", test_token_2->uuid);
		...
		cr_assert(true == _np_aaatoken_is_valid(context, test_token_1, np_aaatoken_type_node), "expect that the 1.token is valid");
		cr_assert(true == _np_aaatoken_is_valid(context, test_token_2, np_aaatoken_type_node), "expect that the 2.token is valid");
		cr_assert(true == _np_aaatoken_is_valid(context, test_token_3, np_aaatoken_type_node), "expect that the 3.token is valid");

		ev_sleep(1.);

		cr_assert(false == _np_aaatoken_is_valid(context, test_token_1, np_aaatoken_type_node), "expect that the 1.token is not valid");
		cr_assert(false == _np_aaatoken_is_valid(context, test_token_3, np_aaatoken_type_node), "expect that the 3.token is not valid");
