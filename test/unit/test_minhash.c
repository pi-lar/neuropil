...
Test(np_minhash_t, _minhash_create, .description="test the functions to create a minhash")
{
    // minhash seed
    np_dhkey_t subject_dhkey = _np_msgproperty_dhkey(INBOUND, "urn:np:test:minhash:v4");
    ...
    RB_FOREACH(tmp, np_tree_s, (text_as_array))
    {
        ...
        {
            char substring[255];
            snprintf(substring, 255, "%s %s %s %s %s\n", part[0], part[1], part[2], part[3], part[4]);
...
Test(np_minhash_t, _minhash_compare_single_shingle, .description="test the minhash functions and compare several documents")
{
    np_minhash_t minhash_1_1, minhash_1_2;
    np_minhash_t minhash_2_1, minhash_2_2;
    np_minhash_t minhash_3_1, minhash_3_2;

    np_dhkey_t seed_dhkey = _np_msgproperty_dhkey(INBOUND, "urn:np:test:minhash_compare:v1");
    ...
    char text_3[] = "Lorem ipsum dolor sit amet, at vero eos et accusam, Stet clita kasd gubergren et dolore magna aliquyam erat, sed diam voluptua.";
...
/*
    ...
    for (uint32_t k = 0; k < _lsh.bands; k++)
    {
        ...
        {
            fprintf(stdout, "(%5d) %15u %15p ", l+k*_lsh.entries-1, _lsh.values[l+k*_lsh.entries-1].hash, _lsh.values[l+k*_lsh.entries-1].value);
        }
        fprintf(stdout, "\n");
    }
*/
...
Test(np_minhash_t, _minhash_compare_tripple_shingle, .description="test the minhash functions and compare several documents")
{
    np_minhash_t minhash_1_1, minhash_1_2;
    np_minhash_t minhash_2_1, minhash_2_2;
    np_minhash_t minhash_3_1, minhash_3_2;
...
*/
    ...
    np_minhash_similarity(&minhash_2_2, &minhash_test, &result);
    cr_expect(0.05 < result, "expect the document similarity to be greater than 0.1");
    cr_expect(0.15 > result, "expect the document similarity to be less than 0.2");
    // fprintf(stdout, "similarity of documents 2.2 to test minhash is %f\n", result);
...
Test(np_minhash_t, _minhash_compare_odrl, .description="test the minhash functions and compare several odrl policies")
{
    np_minhash_t minhash_1_1, minhash_1_2;
    np_minhash_t minhash_2_1, minhash_2_2;
    np_minhash_t minhash_3_1, minhash_3_2;

    np_dhkey_t seed_dhkey = _np_msgproperty_dhkey(INBOUND, "urn:np:test:odrl_policy:compare");
    ...
    char text_3[] = "{ \"@context\": \"http://www.w3.org/ns/odrl.jsonld\", \"@type\": \"Set\", \"uid\": \"http://example.com/policy:1010\", \"permission\": [ { \"target\": \"http://example.com/asset:9898.movie\", \"action\": \"display\", \"constraint\": [ { \"leftOperand\": \"dateTime\", \"operator\": \"gt\", \"rightOperand\":  { \"@value\": \"2019-01-01\", \"@type\": \"xsd:date\" } } ] } ] }";
