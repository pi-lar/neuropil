...
class IdentityAttributeTest(unittest.TestCase):
    ...
    def test_connect(self):
        ...
        np_1.set_attr_bin("2TEST", b"LOREM IPSUM2", inheritance=neuropil.NP_ATTR_IDENTITY)
        np_1.set_attr_bin("3TEST", b"LOREM IPSUM3", inheritance=neuropil.NP_ATTR_IDENTITY_AND_USER_MSG)
        np_1.set_attr_bin("4TEST", b"LOREM IPSUM4", inheritance=neuropil.NP_ATTR_INTENT_AND_IDENTITY)
