...
int main(void) {
  ...
  */
  ...
  /**
     ...
     message with the subject ``"mysubject"`` using :c:func:`np_send` inside a
     dedicated thread. If anything goes wrong we return the error code (an
     :c:type:`np_return`.)
...
/**
 The user input will be dealt with in a separate thread. It will get the
 neuropil context and a running indicator as arguments and will continously ask
 the user for new messages to send. \code
 */
