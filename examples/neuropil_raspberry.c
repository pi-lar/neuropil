...
void handle_ping_pong_receive(np_context        *context,
                              char              *response,
                              int                first_low,
                              int                first_high,
...
bool receive_ping(np_context *context, struct np_message *message) {
  handle_ping_pong_receive(context,
                           "pong",
                           LED_GPIO_YELLOW,
                           LED_GPIO_RED,
                           message);
...
bool receive_blue_button_pressed(np_context        *context,
                                 struct np_message *message) {
  is_blue_pressed = true;
  return true;
}

bool receive_blue_button_reset(np_context        *context,
                               struct np_message *message) {
...
int main(int argc, char **argv) {
  ...
  if (strcmp(opt_instance_no, "1") == 0) {
    np_add_receive_cb(context,
                      "blue_button_pressed",
                      receive_blue_button_pressed);
    np_send(context, "blue_button_reset", (uint8_t *)"test", 5);
    np_send(context, "green_button_pressed", (uint8_t *)"test", 5);
