...
sll_return(np_msgproperty_conf_ptr) default_search_msgproperties(np_state_t* context) {
    ...
    np_new_obj(np_msgproperty_conf_t, __search_node_properties, ref_system_msgproperty);
    ...
    np_new_obj(np_msgproperty_conf_t, __search_entry_properties, ref_system_msgproperty);
    ...
    np_new_obj(np_msgproperty_conf_t, __search_query_properties, ref_system_msgproperty);
    ...
    np_new_obj(np_msgproperty_conf_t, __search_result_properties, ref_system_msgproperty);
...
sll_return(np_msgproperty_conf_ptr) search_peer_msgproperties(np_state_t* context) {
